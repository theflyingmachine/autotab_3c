...
if (isset($_REQUEST['editduration'])) {
    ...
    $sql = "UPDATE linklist SET mon=$mon, tue=$tue, wed=$wed, thu=$thu, fri=$fri, sat=$sat, sun=$sun, duration = '$editduration', link='$elink', tabname='$ename' WHERE linkid='$editlink' AND clientid='$login_id'";
    // echo $sql;
    // exit;
